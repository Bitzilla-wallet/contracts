...
contract FluxBSCFarm is Ownable, ReentrancyGuard {
    using SafeMath for uint256;
    ...
    // Token address
    address public NATIVE = 0x318f401a7eb5cee36b4b6d7fd25fff3e9fe9eba0;
    ...
    uint256 public NATIVEPerBlock = 271232876712329000; // NATIVE tokens created per block
    // Approx 8/3/2021
    uint256 public startBlock = 5996000; // https://bscscan.com/block/countdown/5996000
