...
/**
 * @dev FluxFARM functions that do not require less than the min timelock
 */
interface IFluxFARM {
    function add(
        uint256 _allocPoint,
...
contract TimelockController is AccessControl {
    ...
    address payable public devWalletAddress = 0xF9dDce4cEBf4E8EA9a3B3CB2f47C483F83D7b469;
    /**
    ...
    function executeSet(
        ...
        _beforeCall(predecessor);
        IFluxFARM(_FluxFARMAddress).set(_pid, _allocPoint, _withUpdate);
        _afterCall(id);
    }
    ...
    function add(
        ...
        IFluxFARM(_FluxFARMAddress).add(0, _want, _withUpdate, _strat); // allocPoint = 0. Schedule set (timelocked) to increase allocPoint.
    }
